let pages = [
      {id: 1, text: "<h3>Довгаль Д.Ф.</h3> <p>Всім бажаю успіхів у навчанні та стати поліцейським.</p>
            <div class='tab'>
            <input id='tab-one' type='checkbox'>
            <label for='tab-one'>Учбові матеріали:</label>
            <div class='tab-content'>
                  <ul>
                        <li>
                              <a href='https://pp16-20.pp.ua/educational-materials.html'>Сторінка з учбовими матеріалами;</a>
                        </li>
                        <li>
